About smif-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/smif-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4522&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/smif-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `smif` can be installed with `conda`:
...
It is possible to list all of the versions of `smif` available on your platform with `conda`:
...
```
mamba search smif --channel conda-forge
```
...
mamba repoquery search smif --channel conda-forge

# List packages depending on `smif`:
mamba repoquery whoneeds smif --channel conda-forge

# List dependencies of `smif`:
mamba repoquery depends smif --channel conda-forge
```
